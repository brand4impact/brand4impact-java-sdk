...
import com.brand4impact.client.invoker.auth.Authentication;
import com.brand4impact.client.invoker.auth.HttpBasicAuth;
import com.brand4impact.client.invoker.auth.HttpBearerAuth;
import com.brand4impact.client.invoker.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "http://localhost:8080/backend";
    ...
    public ApiClient() {
        ...
        authentications.put("BearerAuthentication", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8080/backend
